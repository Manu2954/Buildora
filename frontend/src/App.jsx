  ...
  return (
    <Router>
      <AdminAuthProvider>
        ...
        */}
        {/* <Navbar /> */}{" "}
        {/* If Navbar is global, place it here. Or handle in specific routes/layouts. */}
        <Routes>
          ...
          />{" "}
          {/* Corrected path from user's /verify */}
          ...
          <Route
            ...
            element={
              <AdminPrivateRoute>
                {" "}
                {/* This is the admin-specific PrivateRoute */}
                <AdminLayout />{" "}
                {/* AdminLayout contains its own Navbar/Sidebar and an Outlet */}
              </AdminPrivateRoute>
            }
          >
