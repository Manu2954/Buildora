...
const DeleteConfirmationModal = ({ isOpen, onClose, onConfirm, productName }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
            <div className="bg-surface rounded-lg shadow-xl p-6 m-4 max-w-md w-full">
                ...
                <div className="mt-6 flex justify-end space-x-3">
                    <button
                        type="button"
                        onClick={onClose}
                        className="bg-surface py-2 px-4 border border-border rounded-md shadow-sm text-sm font-medium text-text hover:bg-background focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
                    >
                        Cancel
                    </button>
                    <button
